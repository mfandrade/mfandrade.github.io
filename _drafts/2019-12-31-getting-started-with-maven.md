...
Everyone who begin your studies with Java programming language faces yourself
with the concept of [classpash](http://www.guj.com.br/articles/108), that means
where there will be the classes that are part of our programs.

As we start creating bigger and more complex Java projects, and need to
organize the files in proper folders, integrate them with other classes that
need to be loaded from other locations, this start becoming an issue.
